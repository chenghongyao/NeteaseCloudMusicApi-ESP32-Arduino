...
namespace netease {
  ...
  const char nonce[] = "0CoJUm6Qyw8W8jud";
  const char modulus[] =
  ...
  void createSecretKey(char* key, size_t size) {
  ...
  //
  char* aesEncrypt(const char* data, const char* key) {
  ...
  char* rsaEncrypt(const char* data, size_t dataLen) {
